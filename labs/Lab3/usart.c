...
int charReceivedFlag; //if the user has typed a character
uint8_t charReceived; //the typed character
...
void serial_open(void){
		...
		USART2->CR1 |= USART_CR1_TE | USART_CR1_RE | USART_CR1_UE | USART_CR1_RXNEIE; //enable
